...
int main() {
    ...
    registerMovie(movies, "Mec patmutyun poqr qaxaqum", 120, "PG-13",
                  {"2023-07-15 11:30", "2023-07-15 16:00", "2023-07-15 20:30"});
    ...
    bookTicket(movies, users, tickets, "Mec patmutyun poqr qaxaqum", "2023-07-15 16:00", "Gago", "gago@gmail.com",
               "B5");
